...
export const GoogleGeminiEffect = ({
  ...
  return (
    <div className={cn("sticky h-[550px] top-20", className)}>
      <p className="text-xl md:text-7xl font-normal pb-4 text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 to-neutral-300">
        {title || `Find & Book Performing Artists`}
      </p>
      <p className="text-xs md:text-xl font-normal text-center text-neutral-400 mt-4 max-w-lg mx-auto">
        {description || `Connecting event planners with talented artists across India.`}
      </p>
      ...
      <svg
        ...
        className=" absolute -top-60  md:-top-40 w-full z-10"
      >
        {/* Animated Paths */}
        {["#FFB7C5", "#FFDDB7", "#B1C5FF", "#4FABFF", "#076EFF"].map((color, index) => (
          <motion.path
            key={index}
            d={PATHS[index]}
            stroke={color}
...
// Extracted paths into an array for cleanliness
const PATHS = [
